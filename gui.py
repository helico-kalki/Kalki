...
from PyQt6.QtGui import QIcon, QColor, QFont, QPalette, QAction, QIntValidator, QActionGroup, QPixmap
...
def pick_text_color():
    ...
    if dark_mode == True:
        dialog.setStyleSheet("""
            QDialog { background-color: #1c1c28;
                    font-family: 'Lexend Deca'; font-size: 17px; color: white;
                }
        """)
    else:
        dialog.setStyleSheet("""
            QDialog { background-color: #d3d3d3;
    ...
    if dark_mode == True:
        color_picker_widget.setStyleSheet("""
            QWidget {
...
def use_gradient():
    ...
    if dark_mode == True:
        color_picker_widget1.setStyleSheet("""
            QWidget {
                background-color: #1c1c28;
                color: white;
            }
    ...
    if dark_mode == True:
        color_picker_widget2.setStyleSheet("""
            QWidget {
                background-color: #1c1c28;
                color: white;
            }
...
def open_temperature_options(canvas):
    ...
    value_label_temp.setStyleSheet("border: transparent; background: transparent;")
    ...
    value_label_tint.setStyleSheet("border: transparent; background: transparent;")
...
def toggle_dark_mode(enabled: bool):
    if enabled:
        ...
        QMenu::item:selected { background-color: #646478; }
        QMenu::icon { width: 35px; height: 35px; margin-right: 8px; margin-left: 16px; }
        QMenu::separator { height: 1px; background-color: #d3d3d3; margin: 5px 0; }
        QMenu::item:disabled { color: gray; }
        QMenu::item:checked { background-color: #909090; }
        ...
        disableshape.setText("Disable Shapes")
        d_menu.setStyleSheet("""
        QMenu { background-color: #d3d3d3;
                font-family: 'Lexend Deca'; font-size: 17px;
            }
        ...
        # Reset color picker widget to light mode
        color_widget.setStyleSheet("""
            QWidget {
                background-color: #d3d3d3;
                color: black;
