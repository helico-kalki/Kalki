...
class ColorPickerWidget(QWidget):
    ...
    def __init__(self, initial_color=QColor(0, 0, 0), parent=None):
        ...
        self.preview.setStyleSheet(f"background-color: {self.color.name()}; border: 2px solid black; border-radius: 15px;")
        ...
        self.eyedropper.setIcon(QIcon("colored_textures/color_picker.png"))
        self.eyedropper.setIconSize(QSize(30,30))
        self.eyedropper.setStyleSheet("border: none; background: transparent;")
    ...
    def _update_color_from_hsv(self):
        ...
        canvas.set_pen_color(self.color)
    ...
    def _update_from_hsv_text(self):
        ...
        try:
            ...
            self.color.setHsv(h_val, s_val, v_val, self.a_slider.value())
    ...
    def set_color(self, color):
        """Update the color picker widget when color is changed externally"""
        if self.updating:
            return
        self.updating = True
...
def pick_text_color():
    ...
    ok_button.setStyleSheet("border: transparent; background: #00B512; height: 30px; border-radius: 15px; font-family: 'Lexend Deca'; font-size: 17px; color: white;")
    cancel_button = QPushButton("Cancel")
    cancel_button.setStyleSheet("border: transparent; background: #E12C29; height: 30px; border-radius: 15px; font-family: 'Lexend Deca'; font-size: 17px; color: white;")
    ...
    if dialog.exec() == QDialog.DialogCode.Accepted:
        ...
        t_color.setStyleSheet(f"background: {selected_color.name()}; border: transparent; border-radius: 15px;")
...
def update_text_color_from_pen(color: QColor):
    """Update text color when pen color changes"""
...
def pick_color():
    ...
    if dialog.exec() == QDialog.DialogCode.Accepted:
        selected_color = color_picker_widget.color
        d_color.setStyleSheet(f"background: {selected_color.name()}; border: transparent; border-radius: 15px;")
...
def use_gradient():
    ...
    dialog1.setFixedSize(600, 300)
    dialog1.setStyleSheet("background-color: #d3d3d3;")
    
    layout1 = QVBoxLayout(dialog1)

    color_picker_widget1 = ColorPickerWidget()
    color_picker_widget1.set_color(canvas.pen_color)
    layout1.addWidget(color_picker_widget1)

    button_layout1 = QHBoxLayout()
    ok_button1 = QPushButton("OK")
    ok_button1.setStyleSheet("border: transparent; background: #00B512; height: 30px; border-radius: 15px; font-family: 'Lexend Deca'; font-size: 17px; color: white;")
    cancel_button1 = QPushButton("Cancel")
    cancel_button1.setStyleSheet("border: transparent; background: #E12C29; height: 30px; border-radius: 15px; font-family: 'Lexend Deca'; font-size: 17px; color: white;")
    ...
    dialog2.setFixedSize(600, 300)
    dialog2.setStyleSheet("background-color: #d3d3d3;")
    
    layout2 = QVBoxLayout(dialog2)

    color_picker_widget2 = ColorPickerWidget()
    color_picker_widget2.set_color(canvas.pen_color)
    layout2.addWidget(color_picker_widget2)

    button_layout2 = QHBoxLayout()
    ok_button2 = QPushButton("OK")
    ok_button2.setStyleSheet("border: transparent; background: #00B512; height: 30px; border-radius: 15px; font-family: 'Lexend Deca'; font-size: 17px; color: white;")
    cancel_button2 = QPushButton("Cancel")
    cancel_button2.setStyleSheet("border: transparent; background: #E12C29; height: 30px; border-radius: 15px; font-family: 'Lexend Deca'; font-size: 17px; color: white;")
...
color_widget.colorChanged.connect(lambda c: color_wheel.setStyleSheet(f"background: {c.name()}; border-radius: 22px;"))
